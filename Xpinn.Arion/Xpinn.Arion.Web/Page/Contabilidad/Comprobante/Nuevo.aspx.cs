...
public partial class Nuevo : GlobalWeb
{
    ...
    public void GeneraReporteComprobantePago(object sender, int GuaradarSession = 0)
    {
        ...
        var fechsa = GuaradarSession != 1 ? txtFecha.Text : DateTime.Now.ToShortDateString();
        string a = Convert.ToDateTime(fechsa).ToString("yyyy/MM/dd");
        ...
        foreach (DetalleComprobante item in LstDetalleComprobante)
        {
            ...
            if (txtnom.Text != "")
                ...
                datarw[2] = HttpUtility.HtmlDecode(vacios(vComprobante.nombres));
            ...
            datarw[7] = vacios(vComprobante.num_comp.ToString());
            datarw[8] = vacios(vComprobante.iden_benef);
            datarw[9] = vacios(ddlTipoIdentificacion.SelectedItem.Text);
            datarw[10] = HttpUtility.HtmlDecode(vacios(vComprobante.nombres));
            ...
            datarw[19] = item.tipo;
            datarw[20] = vacios(totalD.ToString());
            datarw[21] = vacios(totalC.ToString());
            datarw[22] = txtNumSop.Text;
            datarw[23] = HttpUtility.HtmlDecode(vacios(vComprobante.observaciones));
            datarw[24] = vacios(ddlTipoComprobante.SelectedValue);
            datarw[25] = item.centro_costo;

            datarw[26] = HttpUtility.HtmlDecode(vacios(vComprobante.direccion));
            datarw[27] = HttpUtility.HtmlDecode(vacios(vComprobante.telefono));
        ...
        if (ddlTipoComprobante.SelectedValue == "5")
        {
            ...
            param[5] = new ReportParameter("pIdentificacion", HttpUtility.HtmlDecode(vacios(vComprobante.iden_benef)));
            param[6] = new ReportParameter("pTipoIdentificacion", vacios(ddlTipoIdentificacion.SelectedItem.Text));
            param[7] = new ReportParameter("pNombres", HttpUtility.HtmlDecode(vacios(vComprobante.nombres)));
            param[8] = new ReportParameter("pConcepto", HttpUtility.HtmlDecode(vacios(ddlConcepto.SelectedItem.Text)));
            param[9] = new ReportParameter("pElaborado", HttpUtility.HtmlDecode(vacios(vComprobante.elaboro)));
            ...
            param[12] = new ReportParameter("pTotalDebito", HttpUtility.HtmlDecode(vacios(totalD.ToString().Replace(gSeparadorDecimal, "."))));
            param[13] = new ReportParameter("pTotalCredito", HttpUtility.HtmlDecode(vacios(totalC.ToString().Replace(gSeparadorDecimal, "."))));
            param[14] = new ReportParameter("detalle", HttpUtility.HtmlDecode(vacios(vComprobante.observaciones)));
            if (pEntity != null && pEntity.valor != null)
            {
                if (pEntity.valor == "1")
                    cardinal = " ";
            ...
            param[16] = new ReportParameter("valor", valor);
            if (txtnom.Text.Trim() == "")
                param[17] = new ReportParameter("nombre1", vacios(HttpUtility.HtmlDecode(vComprobante.nombres)));
            else
                param[17] = new ReportParameter("nombre1", vacios(HttpUtility.HtmlDecode(txtnom.Text)));
            param[18] = new ReportParameter("NumCheque", HttpUtility.HtmlDecode(vComprobante.soporte));
            ...
            param[21] = new ReportParameter("pdireccion", HttpUtility.HtmlDecode(vComprobante.direccion));
            param[22] = new ReportParameter("ptelefono", HttpUtility.HtmlDecode(vComprobante.telefono));
        ...
        else if (ddlTipoComprobante.SelectedValue == "1")
        {
            ...
            param[0] = new ReportParameter("pEntidad", HttpUtility.HtmlDecode(pUsuario.empresa));
            param[1] = new ReportParameter("pNumComp", HttpUtility.HtmlDecode(vacios(vComprobante.num_comp.ToString())));
            param[2] = new ReportParameter("pFecha", HttpUtility.HtmlDecode(vacios(fecha)));
            param[3] = new ReportParameter("pTipoComprobante", HttpUtility.HtmlDecode(vacios(ddlTipoComprobante.SelectedValue)));
            param[4] = new ReportParameter("pTipoComprobante2", HttpUtility.HtmlDecode(vacios(ddlTipoComprobante.SelectedItem.Text.ToUpper())));
            param[5] = new ReportParameter("pIdentificacion", HttpUtility.HtmlDecode(vacios(vComprobante.iden_benef)));
            ...
            param[10] = new ReportParameter("pCiudad", HttpUtility.HtmlDecode(vacios(ddlCiudad.SelectedItem.Text)));
            param[11] = new ReportParameter("pTipoBeneficiario", HttpUtility.HtmlDecode(vacios(tipobeneficiario)));
            param[12] = new ReportParameter("pTotalDebito", HttpUtility.HtmlDecode(vacios(totalD.ToString())));
            param[13] = new ReportParameter("pTotalCredito", HttpUtility.HtmlDecode(vacios(totalC.ToString())));
            param[14] = new ReportParameter("detalle", HttpUtility.HtmlDecode(vacios(vComprobante.observaciones)));
            if (pEntity != null && pEntity.valor != null)
            {
                if (pEntity.valor == "1")
            ...
            param[15] = new ReportParameter("NumCheque", HttpUtility.HtmlDecode(vComprobante.soporte));
            param[16] = new ReportParameter("valor", HttpUtility.HtmlDecode(valor));
            if (txtnom.Text.Trim() == "")
                param[17] = new ReportParameter("nombre1", HttpUtility.HtmlDecode(vacios(vComprobante.soporte)));
            else
                param[17] = new ReportParameter("nombre1", HttpUtility.HtmlDecode(vacios(txtnom.Text)));
            param[18] = new ReportParameter("Numerocuenta", HttpUtility.HtmlDecode(vComprobante.soporte));
            param[19] = new ReportParameter("pNit", HttpUtility.HtmlDecode(pUsuario.nitempresa));
            param[20] = new ReportParameter("ImagenReport", cRutaDeImagen);
            ...
            foreach (GridViewRow gvbuscar in gvDetMovs.Rows)
            {
                ...
                {
                    param[25] = new ReportParameter("valportotal", (vComprobante.totalcom.ToString()));
        ...
        if (GuaradarSession != 0)
        {
            ...
            byte[] bytes = RpviewComprobante.LocalReport.Render(
    ...
    //Se crea el metodo que se va a consumir desde el otro lado. 
    public MemoryStream GenerarComprobanteMemoryStream(long numComp, long tipoComp)
    {
        Xpinn.Contabilidad.Services.ComprobanteService ComprobanteServicio = new Xpinn.Contabilidad.Services.ComprobanteService();
        List<Xpinn.Contabilidad.Entities.DetalleComprobante> LstDetalleComprobante = new List<Xpinn.Contabilidad.Entities.DetalleComprobante>();
        Xpinn.Contabilidad.Entities.Comprobante vComprobante = new Xpinn.Contabilidad.Entities.Comprobante();
        if (ComprobanteServicio.ConsultarComprobante(numComp, tipoComp, ref vComprobante, ref LstDetalleComprobante, (Usuario)Session["Usuario"]))
        {
            Session["DetalleComprobante"] = LstDetalleComprobante;
        }

        object obj = new object();
        GeneraReporteComprobantePago(obj, 1);

        MemoryStream ms = (MemoryStream)Session["Memorias"];
        return ms;
    }
                ...
                if (bModificar == false || (bModificar == true && detalle != null))
                {
                    ...
                    if (txtBaseGrid.Text != null)
                    {
                        if (txtBaseGrid.Text.Trim() != "")
                            detalle.base_comp = Convert.ToDecimal(txtBaseGrid.Text.Replace(".", ""));
                        else
                    ...
                    if (txtPorcentGrid != null)
                    {
                        if (txtPorcentGrid.Text.Trim() != "")
                            detalle.porcentaje = Convert.ToDecimal(txtPorcentGrid.Text.Replace(".", ""));
                        else
            ...
            if (cont == Convert.ToInt32(Session["INDICEADD"].ToString()))
            {
                if (gvImpuestos.Rows.Count > 0)
                {
                    foreach (GridViewRow rFila in gvImpuestos.Rows)
                    {
                        ...
                        if (Convert.ToInt32(PlanCuentas.es_impuesto) >= 1)
                        {
                            pDetalleComprobante.base_comp = base_comp;
                            pDetalleComprobante.porcentaje = porcentaje;
                        }
                        else
                        {
                            pDetalleComprobante.base_comp = null;
