...
public partial class ctlMora : System.Web.UI.UserControl
{
    ...
    public void Actualizar()
    {
        ...
        try { txtMora.Text = Convert.ToString(_servicio.ConsultarTotalValorMoraPersona(txtCodigo.Text, txtIdentificacion.Text, Convert.ToDateTime(txtFechaCorte.Text), pusuario)); } catch { }
        if (txtMora.Text == "0")
        {
