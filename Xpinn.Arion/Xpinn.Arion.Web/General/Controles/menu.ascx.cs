...
public partial class ctrl_menu : System.Web.UI.UserControl
{
    ...
    private void CrearMenu()
    {
        try
        {
            ...
            {
                phOpciones.Controls.Add(new LiteralControl("<ul><span style='margin-left:0px; font-weight: bolder;'>" + arProcesos[c].ToString() + "</span>"));
                ...
                for (int p = 0; p < arOpciones.Count; p++)
                {
                    ...
                    phOpciones.Controls.Add(new LiteralControl("<li style='text-align: left'>"));
