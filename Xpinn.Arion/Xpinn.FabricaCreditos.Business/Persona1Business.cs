        ...
        public Persona1 ConsultarPersona1Param(Persona1 pPersona1, Usuario pUsuario)
        {
            try
            {
                ...
                if (pPersona != null)
                {
                    ...
                    {
                        Int64 idImagen = 0;
                        pPersona.foto = DAImagenes.ConsultarImagenPersona(Convert.ToInt64(pPersona.cod_persona), Convert.ToInt64(pPersona.tipo_identificacion), ref idImagen, pUsuario);
