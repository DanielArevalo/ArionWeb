...
namespace Xpinn.FabricaCreditos.Services
{
    ...
    public class ActasService
    {
        ...
        public Credito CrearRadicadosActas(Credito pReporte, Usuario pUsuario, String idacta, DateTime fechaaprobacion, Int64 codusuario, Int64 codperfil)
        {
            try
            {
                return BoReporte.CrearRadicadosActas(pReporte, pUsuario, idacta, fechaaprobacion, codusuario, codperfil);
            }
            catch (Exception ex)
            {
