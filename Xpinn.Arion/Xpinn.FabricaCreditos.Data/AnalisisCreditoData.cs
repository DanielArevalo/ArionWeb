                        ...
                        switch (tipoPersona)
                        {
                            case 0:
                                sql =
                                    ...
                                    OTROS_DESCUENTOS_DEU OtrosDescuentos, DEUDAS_TERCERO_DEU DeudasTercero from ANALISIS_CRE_INFO where Numero_radicacion = " + numeroRadicacion;
                                break;
                            case 1:
                                sql =
                                    ...
                                    OTROS_DESCUENTOS_Cod1 OtrosDescuentos, DEUDAS_TERCERO_Cod1 DeudasTercero from ANALISIS_CRE_INFO where Numero_radicacion =" + numeroRadicacion;
                                break;
                            case 2:
                                sql =
                                    ...
                                    OTROS_DESCUENTOS_Cod2 OtrosDescuentos, DEUDAS_TERCERO_Cod2 DeudasTercero from ANALISIS_CRE_INFO where Numero_radicacion =" + numeroRadicacion;
                                break;
                            case 3:
                                sql =
                                    ...
                                    OTROS_DESCUENTOS_Cod3 OtrosDescuentos, DEUDAS_TERCERO_Cod3 DeudasTercero from ANALISIS_CRE_INFO where Numero_radicacion =" + numeroRadicacion;
                                break;
                        }
