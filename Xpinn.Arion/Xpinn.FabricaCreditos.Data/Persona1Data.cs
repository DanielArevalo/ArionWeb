            ...
            using (DbConnection connection = dbConnectionFactory.ObtenerConexion(vUsuario))
            {
                using (DbCommand cmdTransaccionFactory = dbConnectionFactory.dbProveedorFactory.CreateCommand())
                {
                    try
                    {
                        ...
                        DbParameter p_sueldoper = cmdTransaccionFactory.CreateParameter();
                        p_sueldoper.ParameterName = "P_SUELDOPER";
                        p_sueldoper.Value = pPersona.Sueldo_Persona;
                        p_sueldoper.Direction = ParameterDirection.Input;
                        cmdTransaccionFactory.Parameters.Add(p_sueldoper);



                        DbParameter pcod_sueldo = cmdTransaccionFactory.CreateParameter();
                        pcod_sueldo.ParameterName = "P_CUOTA";
                        pcod_sueldo.Value = pPersona.cuota;
                        pcod_sueldo.Direction = ParameterDirection.Input;
                        cmdTransaccionFactory.Parameters.Add(pcod_sueldo);
